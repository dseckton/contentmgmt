...
export const MOCKCONTACTS: Contact[] = [
  // individual contacts
  {
    id: '19', name: 'Daniel Eckton', email: 'eck15001@byui.edu', phone: '555-867-5309', imageUrl: null, group: null
  },
  // index 0
  {
    id: '1',
  ...
  // index 13
  {
    id: '4', name: 'Network/OS team', email: null, phone: null, imageUrl: null, group: [
    {
      id: '2',
      name: 'Bradley Armstrong',
      email: 'armstrongb@byui.edu',
  ...
  // index 14
  {
    id: '6', name: 'Software Development team', email: null, phone: null, imageUrl: null, group: [
    {
      id: '1',
      name: 'Rex Barzee',
      email: 'barzeer@byui.edu',
  ...
  // index 15
  {
    id: '10', name: 'Web Development team', email: null, phone: null, imageUrl: null, group: [
    {
      id: '15',
      name: 'Blaine Robertson',
      email: 'robertsonb@byui.edu',
  ...
  // index 16
  {
    id: '14', name: 'Database team', email: null, phone: null, imageUrl: null, group: [
    {
      id: '7',
      name: 'R. Kent Jackson',
      email: 'jacksonk@byui.edu',
  ...
  // index 17
  {
    id: '18', name: 'Computer Security team', email: null, phone: null, imageUrl: null, group: [
    {
      id: '5',
      name: 'Kory Godfrey',
      email: 'godfreyko@byui.edu',
